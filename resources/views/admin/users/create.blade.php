...
<div class="flex flex-wrap w-full mb-8">
    ...
    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Créer un utilisateur</h1>
...
<div class="my-4">
    ...
    {!! Form::select('roles[]', $roles,[], array('class' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500','multiple')) !!}
</div>
